...
const DOMAINS = [
  {
    ...
    items: [
      ...
      { name: '题材卡组装', entry: 'scripts/assemble-genre-card.js', note: '自动抽 题材定位+索引+genres模板+风格模块 生成 设定/题材正文提示卡.md' },
    ],
  },
  {
    key: 'analyze',
  ...
  },
  {
    ...
    items: [
      ...
      { name: '自测套件', entry: 'scripts/selftest.js', note: '51 脚本语法/启动/功能三层冒烟，改一处不崩一片' },
    ],
  },
];
