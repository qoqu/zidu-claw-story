...
- **自测套件**：selftest 给 50 脚本做语法/启动/功能三层冒烟，改一处不崩一片
...
├── docs/
│   ├── install.md       # 多宿主安装与部署
│   ├── scripts.md       # 50 个脚本命令参考
│   └── references.md    # 知识库（references/）索引
├── scripts/              # 50 个 Node 脚本（质检/去味/追踪/爬虫/CDP/体检/记忆/观/扩/闭环/自测/数据驱动/完结门禁）
...
| [docs/scripts.md](docs/scripts.md) | 50 个脚本分类与命令参考 |
