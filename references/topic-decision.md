...
> 供用户从扫榜结果中挑选对标书去拆。**必须按选题分组，每组内的书严格属于该题材方向，禁止跨题材混排。**
>
> **两步选择流程（闸 A 执行时遵循）：**
> 1. 先展示推荐选题列表（题材+热度+为什么值得关注）→ 用户选 1-2 个板块
> 2. 再只展示所选板块下的候选书 → 用户勾选 1-3 本带入拆书

### 选题 1 对标书
- 《{书名}》/ {作者} / {平台·榜单} / 核心指标：{在读数·月票·收藏}
  - 为什么适合当标杆：{它体现了该选题的哪个爆点，值得拆}
- 《{书名}》/ ...
